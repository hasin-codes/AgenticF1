 ...
 * ===========================
 * 
 * A reusable profile dropdown component that works with the sidebar.
 * Supports both expanded and collapsed states.
 * 
 * MOBILE: Always shows full profile dropdown
 * DESKTOP: Adapts to sidebar collapsed/expanded state
 */
                ...
                <div className="group relative" style={{ minHeight: '40px', position: 'relative' }}>
                    <DropdownMenuTrigger asChild>
                        <button
                            type="button"
                            className={cn(
                                "flex items-center relative rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200/60 dark:border-zinc-800/60 hover:border-zinc-300 dark:hover:border-zinc-700 hover:bg-zinc-50/80 dark:hover:bg-zinc-800/40 hover:shadow-sm focus:outline-none",
                                collapsed ? "w-10 h-10 p-0.5 justify-center" : "w-full h-10 p-3"
                            )}
                            style={{
                        ...
                        >
                            ...
                            <div className="relative shrink-0">
                                <div className="w-9 h-9 rounded-full bg-linear-to-br from-purple-500 via-pink-500 to-orange-400 p-0.5">
                            ...
                            {/* First Name - Only visible when expanded */}
                            {!collapsed && (
                                <span className="ml-3 text-sm font-medium text-zinc-900 dark:text-zinc-100 tracking-tight leading-tight whitespace-nowrap overflow-hidden">
                                    {data.name.split(' ')[0]}
                                </span>
                            )}
                        </button>
