      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute left-0 z-50 mt-1 w-full origin-top rounded-lg border bg-popover shadow-lg max-h-[300px] overflow-y-auto overflow-x-hidden scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent"
            exit={{
              opacity: 0,
              y: -10,
              scaleY: 0.8,
